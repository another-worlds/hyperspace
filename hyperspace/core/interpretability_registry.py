...
ALPHA_SCOPE_MODULE_POLICIES: list[AlphaScopeModulePolicy] = [
    ...
    {
        "module_name": "TFT",
        "owner": "Finance Modeling",
        "status": "contract",
        "rationale": "TFT adapter wraps fit_tft() output to expose attention weights, variable importance, and forecast explanations.",
    },
    {
        "module_name": "BERTopic",
        "owner": "Information Modeling",
        "status": "contract",
        "rationale": "BERTopic adapter wraps fit_topic_model() output to expose topic embeddings, distributions, and coverage metrics.",
    },
    {
        "module_name": "GraphEngine",
        "owner": "Geopolitics Modeling",
        "status": "contract",
        "rationale": "Graph adapter wraps analyze_graph() output to expose communities, centrality attributions, and alliance structure.",
    },
    {
        "module_name": "SpatialKernels",
        "owner": "Spatial Modeling",
        "status": "contract",
        "rationale": "Spatial adapter wraps kernelize_spatial() output to expose SVD kernels, node loadings, and cross-region correlations.",
    },
    {
        "module_name": "AgentSimulation",
        "owner": "Agent Systems",
        "status": "contract",
        "rationale": "Agent adapter wraps run_simulation() output to expose agent states, resource attributions, and alliance spectrum.",
    },
    {
